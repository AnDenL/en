use crate::config::{PowerPreference, RenderSettings};
use std::sync::Arc;
...
impl RenderContext {
    ...
    pub async fn new(window: Arc<Window>, settings: &RenderSettings) -> Result<Self, &'static str> {
        ...
        // wgpu::Instance::default() автоматично використовує wgpu::Backends::all()
        ...
        let adapter = instance
            ...
            .map_err(|_| "Failed to find an appropriate adapter".to_string())
            .unwrap();
