...
pub fn draw(ctx: &egui::Context, ui: &mut egui::Ui, app: &mut EditorApp) {
    ...
    left_ui.label(egui::RichText::new(&app.ui_state.project_path).font(FontId::proportional(12.0)).color(en_ui::theme::TEXT_MUTED));
    ...
    ui.scope_builder(egui::UiBuilder::new().max_rect(header_rect), |ui| {
        ui.vertical_centered(|ui| {
            ...
            ui.horizontal(|ui| {
                ...
                let play_text = if app.ui_state.is_playing { "⏹ Stop Game" } else { "▶ Play Game" };
